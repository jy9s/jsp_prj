...
public class UseSHA {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DataEncryption de = new DataEncryption(key);//16자의 키
			
			String chiperText=de.encrypt("min@test.com");
