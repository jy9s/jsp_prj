...
<body>
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="right">
				<div style="font-family: Noto Sans KR, sans-serif; font-weight: bold; font-size: 35px; margin-left: 20px">공지 관리</div>
				...
				<form id="notice" name="notice" action="AdminNoticeWrite.jsp">
					<input class="share-button" type="button" onclick="writeNotice()" style="font-size:17px;padding-top:5px;padding-bottom:5px; margin-right:10px" value="글쓰기">
				</form>
				</div>
