...
<body>
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="right">
				<div style="font-family: Noto Sans KR, sans-serif; font-weight: bold; font-size: 35px; margin-left: 20px">회원 정보 조회</div>
				
				<div style="display:flex; justify-content: flex-end; padding-right:100px; margin-top:50px">

					<div class="dropdown-center search-filter">
						<button class="btn btn-light dropdown-toggle" type="button"
							data-bs-toggle="dropdown" aria-expanded="false" id="category">전체</button>
					...
					<div style="margin-left:10px">
						<button class="share-button" type="button" id="search-button" onclick="searchUser()" style="font-size:17px;padding-top:5px;padding-bottom:5px;">조회</button>
					</div>				
				</div>
