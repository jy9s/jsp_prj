				...
				<div class="col-md-7">
					...
					<table id="joinFrm">
						...
						<tr>
							...
							<img src="${CommonURL}/upload/${pDTO.profile}"
							style="width:100px; height:100px; border-radius:50px" id="preview"><br>
						...
						<tr>
							...
							<td class="input"><strong><c:out value="${pDTO.name}"/></strong>
						</tr>
						<tr>
						...
						<td><textarea name="intro" style="width: 400px;height: 100px">${pDTO.intro }</textarea></td>
						</tr>
						<tr>
