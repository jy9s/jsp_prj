...
function postSend(){
	...
	document.frm.submit(); //VS를 사용한 이동
}
</script>
	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div style="width: 480px">
				...
				<strong>상황에 따라 GET또는 POST로 변환되는 방식</strong>
					<label>관심언어</label> <input type="checkbox" name="language"
						value="java" /> 자바 <input type="checkbox" name="language" value="C" />
					C/C++ <input type="checkbox" name="language" value="visual basic" />비주얼베이직
					<input type="checkbox" name="language" value="PyThon" />파이썬 <input
