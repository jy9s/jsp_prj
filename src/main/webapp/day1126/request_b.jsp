...
<link rel="shortcut icon"
	href="http://192.168.10.72/html_prj/common/images/favicon.ico" />
...
<link href="http://192.168.10.72/jsp_prj/common/css/carousel.css"
	rel="stylesheet">
...
<body>
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div class="col-md-7">
					...
					%>
					<div class="counter">
						<span class="count"> <%=name%>님 어서오고!!</span>
					</div>
					
					작업페이지<a href="request_c.jsp">이동</a>
		...
		<footer class="container">
			...
			<p>
				&copy; SIST class2. &middot; <a href="#">개인정보보호정책</a> &middot;
				개인정보관리 책임자 님이셈
			</p>
		</footer>
	</main>
