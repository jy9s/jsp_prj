...
.blankTd{background-color:gray;}

.sunTitle, .weekTitle, .satTitle{
	width:120px;
	text-align:center;
}
.sunTitle{color:#C7C8C9; background-color:#DE4F44}
.weekTitle{font-weight:normal;}
.satTitle{color:#C7C8C9; background-color:#327EFF}

a{ text-decoration: none; color:white}
a:hover {color:gray}

.sunText{color:#DA3F35}
.weekText{color:#FFFFFF}
  ...
  ================================================== -->
		...
		<div class="container marketing">
			...
			<div class="row featurette">
				<div id="calWrap">
				<jsp:useBean id="cDTO" class="kr.co.sist.calendar.CaldendarDTO" scope="page"/>
				...
				//if를 타면 설정된 월이 저장되고, if 타지 않으면 현재월이 저장된다. 
				...
				<div id="calHeader">
					...
					<a href="calandar.jsp?paramYear=<%=nowMonth-1==0 ? nowYear-1:nowYear%>&paramMonth=<%=nowMonth-1==0 ? 12 :nowMonth-1 %>"><span class="calTitle" title="이전월">&lt;</span></a>
					<span class="calTitle"><%=nowYear%>-<%=nowMonth%></span>				
					<a href="calandar.jsp?paramYear=<%=nowMonth+1==13? nowYear+1 : nowYear%>&paramMonth=<%=nowMonth+1==13? 1 : nowMonth+1%>"><span class="calTitle" title="다음월">&gt;</span></a>
					<a href="calandar.jsp" class="btn btn-success">오늘</a>
				</div>
				...
				<tr>
					...
					for(int tempDay=1; ;tempDay++){ //마지막 날을 모름.
						...
						//(현재월에 없는 날짜가 입력되면 자동으로 다음 달 1일이 된다.)
