...
<body class="d-flex align-items-center py-4 bg-body-tertiary">	
	<main class="form-signin w-100 m-auto">
		<form action="${CommonURL}/login/loginFrmProcess.jsp" method="post" id="loginFrm" name="loginFrm">
			...
			<a href="http://localhost/jsp_prj/day1128/usebeanParamForm.jsp">회원 가입</a>
